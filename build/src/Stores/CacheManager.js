...
const DatabaseStore_1 = __importDefault(require("./DatabaseStore"));
const NullStore_1 = __importDefault(require("./NullStore"));
const ObjectStore_1 = __importDefault(require("./ObjectStore"));
